...
%   - [dependency1]
%       - [dependency1 repository address]
%       - [dependency1 notes]
%   - [dependency2]
%       - [dependency2 repository address]
%       - [dependency2 notes]
%   ...
%   - [dependencyN]
%       - [dependencyN repository address]
%       - [dependencyN notes]
%
...
%       - [input1 desc]
%       - [input1 notes]
%       - [input1 example (if applicable)]
%       - [input1 default]
%   - [input2]:
%       - [input2 desc]
%       - [input2 notes]
%       - [input2 example (if applicable)]
%       - [input2 default]
%   ...
%   - [inputN]:
%       - [inputN desc]
%       - [inputN notes]
%       - [inputN example (if applicable)]
%       - [inputN default]
%
% Variable input arguments (type 'help varargin' for usage info):
%   - '[variableinput1 fieldname]':
